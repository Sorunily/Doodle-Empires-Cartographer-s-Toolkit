...
4. Go to the map and edit it. The game will read the PNG and convert it to a map. Then just save the map and voila, you now have a working map. I recommend turning the converter off in the config afterwards.
