...
2. Edit the config to change what map is being targeted. Make sure the map is already made in-game. You can make it a blank map if you'd like and the chosen size will not matter. I recommend making a map named "Converter" and using that as your perpetual conversion spot.
